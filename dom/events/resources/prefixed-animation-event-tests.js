...
function runAnimationEventTests(eventDetails) {
  ...
  if (isTransition) {
    ...
    // Safari requires there to be at least one keyframe declared or it won't
    // create the animation; see https://bugs.webkit.org/show_bug.cgi?id=205732
    style.sheet.insertRule('@keyframes anim { 0% {} }');
  }
  ...
  // TODO(smcgruer): This test arguably belongs in html/webappapis rather than
  // in dom/events/
  test(t => {
